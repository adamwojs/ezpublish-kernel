...
use eZ\Publish\Core\Persistence\Cache\ContentReviewHandler as CacheContentReviewHandler;
...
class Handler implements PersistenceHandlerInterface
{
    ...
    /** @var \eZ\Publish\Core\Persistence\Cache\ContentReviewHandler */
    protected $contentReviewHandler;
     ...
     * @param \eZ\Publish\Core\Persistence\Cache\ContentReviewHandler $contentReviewHandler
    ...
    public function __construct(
        ...
        CacheContentReviewHandler $contentReviewHandler,
        ...
        $this->contentReviewHandler = $contentReviewHandler;
        $this->logger = $logger;
    }
    ...
    /**
     * @return \eZ\Publish\Core\Persistence\Cache\ContentReviewHandler
     */
    public function contentReviewHandler()
    {
        return $this->contentReviewHandler;
    }
