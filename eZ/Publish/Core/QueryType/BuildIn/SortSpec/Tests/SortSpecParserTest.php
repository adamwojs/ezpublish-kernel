...
final class SortSpecParserTest extends TestCase
{
    ...
    public function testParseSortDirection(array $input, string $expectedDirection): void
    {
        ...
        $parser = new SortSpecParser($this->createMock(SortClauseArgsParserInterface::class), $lexer);
    ...
    public function testParseSortClauseList(): void
    {
        ...
        $sortClauseArgsParser = $this->createMock(SortClauseArgsParserInterface::class);
    ...
    public function testMatch(): void
    {
        ...
        $parser = new SortSpecParser(
            $this->createMock(SortClauseArgsParserInterface::class),
            $lexer
        );
